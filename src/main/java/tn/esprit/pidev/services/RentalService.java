...
import tn.esprit.pidev.dao.InventoryDao;
import tn.esprit.pidev.dao.RentalDao;
import tn.esprit.pidev.entities.Inventory;
import tn.esprit.pidev.entities.PaymentStatus;
...
public class RentalService {
    ...
    public boolean cancelRental(int rentalId, String reason) {
        ...
        if (inv != null && inv.getRentalStatus() == tn.esprit.pidev.entities.InventoryRentalStatus.RENTED_OUT) {
            inv.setRentalStatus(tn.esprit.pidev.entities.InventoryRentalStatus.AVAILABLE);
